...
public class XxlJobRemotingUtil {
    ...
    public static ReturnT postBody(String url, String accessToken, int timeout, Object requestObj, Class returnTargClassOfT) {
        ...
        try {
            ...
            // write requestBody
            if (requestObj != null) {
                String requestBody = com.xxl.job.core.util.GsonTool.toJson(requestObj);
            ...
            // parse returnT
            try {
                ReturnT returnT = com.xxl.job.core.util.GsonTool.fromJson(resultJson, ReturnT.class, returnTargClassOfT);
                return returnT;
            } catch (Exception e) {
