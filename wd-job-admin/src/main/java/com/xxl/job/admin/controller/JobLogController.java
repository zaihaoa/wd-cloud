...
public class JobLogController {
	...
	public Map<String, Object> pageList(HttpServletRequest request,
		...
		// page query
		List<XxlJobLog> list = xxlJobLogDao.pageList(start, length, jobGroup, jobId, jobDesc, triggerTimeStart, triggerTimeEnd, logStatus);
		int list_count = xxlJobLogDao.pageListCount(start, length, jobGroup, jobId, jobDesc, triggerTimeStart, triggerTimeEnd, logStatus);
